...
```
 ...
 - **Note**: For bookworm operating system: tested on Debian GNU/Linux 12 (bookworm) kernel Linux 6.6.62+rpt-rpi-v8 64 bits with OpenCV version 4.8.0 and TensorFlow 2.14.0 (Python 3.11.2)*
